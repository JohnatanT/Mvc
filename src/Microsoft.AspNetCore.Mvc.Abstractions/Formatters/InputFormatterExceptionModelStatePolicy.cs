...
namespace Microsoft.AspNetCore.Mvc.Formatters
{
    ...
    /// <c>MvcOptions.InputFormatterExceptionModelStatePolicy</c> to configure this setting.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// The policy associated with <see cref="InputFormatterExceptionModelStatePolicy.AllExceptions"/> treats
    ...
    /// and is stil the default for historical reasons. 
    /// </para>
    /// <para>
    /// The policy associated with <see cref="InputFormatterExceptionModelStatePolicy.MalformedInputExceptions"/>
    /// treats only <see cref="InputFormatterException"/> and subclasses as model state errors. This means that
